...
export const asyncRouterMap = [
  {
    ...
    redirect: '/drilling/trajectory',
    children: [
      // 钻井工程数字化系统
      {
        path: '/drilling/trajectory',
        name: 'TrajectoryDesign',
        component: () => import('@/views/drilling/TrajectoryDesign/index.vue'),
        meta: { title: '轨迹设计', keepAlive: true, permission: ['dashboard'] }
      },
      {
        path: '/drilling/basic-data',
        name: 'BasicData',
        component: () => import('@/views/drilling/BasicData/index.vue'),
        meta: { title: '基础数据', keepAlive: true, permission: ['dashboard'] }
      },
      {
      ...
      //   component: RouteView,
      //   meta: { title: '无源磁导向', keepAlive: true, icon: bxAnaalyse, permission: ['dashboard'] },
      //   children: [
      //     {
      ...
      //       meta: { title: '评估查看', keepAlive: false, permission: ['dashboard'] }
      //     }
      //   ]
      // }
      // // forms
