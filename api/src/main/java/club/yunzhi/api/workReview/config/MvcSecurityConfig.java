...
import club.yunzhi.api.workReview.service.OneTimePassword;
...
//        .antMatchers("/user/userBinding", "/favicon.ico").permitAll()
...
//    configuration.setAllowedOrigins(Arrays.asList("http://localhost:8000", "http://localhost:4200", "http://work-review.yunzhi.club:81"," http://10.129.243.184:8000/"));
